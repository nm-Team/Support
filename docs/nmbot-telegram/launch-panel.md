...
![从任意对话启动 nmBot 面板](/assets/images/nmbot/launch_panel_from_any_chat.png)

也可以在与 nmBot 的对话窗口左下角点击按钮打开 nmBot 面板。

![从与 nmBot 的对话窗口启动 nmBot 面板](/assets/images/nmbot/launch_panel_from_chat_corner.png){ width="200" }
