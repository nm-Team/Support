...
大多数情况下，更改名称或简介后，您不需要联系我们即不会再因为入群或发言被封禁。
因此强烈建议您在发起争议或联系我们之前，先尝试更改名称或简介。

## 我被 nmBot 解除封禁，但群组仍然封禁着我，怎么办？

为了保障群组管理员自行决定封禁用户的权利，我们帮助您在群组中解除封禁[需要该群组的授权](../group/unban-users-banned-by-anti-spam.md)。
...
如果您看到某人声称 nmBot 的封禁导致了 Telegram 封禁了他的账号，那是因为 nmBot 和 Telegram 都一致认为他的账号存在滥用情况。
