...
1. 若页面中提示“已启用双重验证”，则表示您已启用“双重验证”功能。
1. 在“请选择验证方式”部分中，选择“使用 App”。
1. 打开您的“双重验证”应用程序，扫描页面上的二维码。
1. 在“然后输入验证码”部分中，输入您的“双重验证”应用程序中显示的验证码。
1. 点击“下一步”按钮。
1. 若页面中提示“已启用双重验证”，则表示您已成功启用 nmTeam 账号的“双重验证”功能。
...
1. 在导航栏中，点击“🛡 账号安全”。
    在该部分中点击“管理双重验证”按钮。
    或点击此链接打开“管理双重验证”页面：[https://accounts.nmteam.xyz/#/manage/two-factor-authentication-setup](https://accounts.nmteam.xyz/#/manage/two-factor-authentication-setup)
1. 若页面中未提示“已启用双重验证”，则表示您未启用“双重验证”功能。
1. 点按“停用双重验证”按钮。
1. 在页面中最后一次输入您的“双重验证”应用程序中显示的验证码。
1. 点击“停用”按钮。
1. 页面将提示您停用“双重验证”功能成功。
